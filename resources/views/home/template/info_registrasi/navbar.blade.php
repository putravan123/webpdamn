<div class="container-fluid position-relative p-0">
            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="{{route('infoRegistasi')}}" class="dropdown-item">Info Registrasi</a>
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Info Registrasi</h4>
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="{{route('home')}}">Beranda</a></li>
                <li class="breadcrumb-item"><a href="{{route('registrasi')}}">Registras</a></li>
                <li class="breadcrumb-item active text-primary">Info Registrasi</li>
                <li class="breadcrumb-item"><a href="">Info Tagihan</a></li>
                <li class="breadcrumb-item"><a href="">Simulasi Tarif</a></li>
                <li class="breadcrumb-item"><a href="">Kansultasi Publik</a></li>
            </ol>    
        </div>
    </div>
    <!-- Header End -->
