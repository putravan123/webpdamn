<div class="container-fluid position-relative p-0">
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Produk Hukum</h4>
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Beranda</a></li>
                <li class="breadcrumb-item"><a href="{{route('biografi_direksi')}}">Tentang Pdam</a></li>
                <li class="breadcrumb-item"><a href="{{route('tentangPdam')}}">Tentang Pdam</a></li>
                <li class="breadcrumb-item"><a href="{{ route('visi') }}">Visi Misi</a></li>
                <li class="breadcrumb-item"><a href="{{route('struktur')}}">Struktur Orgsnisasi</a></li>
                ...
                <li class="breadcrumb-item active text-primary">Produk Hukum</li>
            </ol>    
        </div>
    </div>
