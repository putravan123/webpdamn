                    ...
                    <div class="col-lg-6 col-xl-4 col-md-6 col-12">
                        <div class="blog-item">
                            ...
                            <div class="blog-content rounded-bottom p-4">
                                <a href="javascript:void(0);" class="h4 d-inline-block mb-3" data-bs-toggle="modal" data-bs-target="#blogModal" onclick="openModal('{{ $galeris->title }}', '{{ addslashes($galeris->content) }}', '{{ asset('storage/' . $galeris->image) }}')">{{ $galeris->title }}</a>
                                
                                @php
                                    $content = $galeris->content;
