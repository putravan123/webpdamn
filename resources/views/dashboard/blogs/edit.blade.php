        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-3">
                        <p>Gambar saat ini:</p>
                        <img src="{{ asset('storage/' . $blog->image) }}" width="150" class="img-thumbnail" alt="{{ $blog->title }}">
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('publish_date') is-invalid @enderror" id="publish_date" name="publish_date" value="{{ old('publish_date', $blog->publish_date) }}" required>
                    @error('publish_date')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
